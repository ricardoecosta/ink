...
{
    public class BlocksMiniPhysicsEngine : GameLibrary.UI.IUpdateable
    {
                                               ...
                                               out Block hCollisionBlock, out Block vCollisionBlock)
        {
            ...
            foreach (var objToTestAgainst in ObjectsListRef)
            {
                ...
                {
                    /*if (blockToTestAgainst.RowIndex == 0 && (blockToTestAgainst.State == Block.States.Dragging || blockToTestAgainst.State == Block.States.Falling)) 
                    {
                        continue;
                    }*/
