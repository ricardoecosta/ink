...
namespace HnK.GameModes
{
    public abstract class Level : Scene
    {
            ...
            : base(GameDirector.Instance, GlobalConstants.DefaultSceneWidth, GlobalConstants.DefaultSceneHeight)
        {
            ...
            AchievementsQueue = new Queue<GameLibrary.Social.Achievements.Achievement>();
        }
        ...
        public override void Initialize()
        {
            ...
            PlaySong();
            LogGameStartPlayingEventToAnalytics();
        }
        ...
        protected void LogGameStartPlayingEventToAnalytics()
        {
//            Director.AnalyticsService.LogEvent(
//                AnalyticsConstants.Events.StartedPlaying,
//                new AnalyticsParameter(AnalyticsConstants.EventParameters.SessionUUID, GameSessionUUID.ToString()),
//                new AnalyticsParameter(AnalyticsConstants.EventParameters.GameMode, GameDirector.Instance.CurrentGameMode.ToString()));
        }

        public void LogGameFinishEventToAnalytics()
        {
//            Director.AnalyticsService.LogEvent(
//                AnalyticsConstants.Events.FinishedPlaying,
//                new AnalyticsParameter(AnalyticsConstants.EventParameters.SessionUUID, GameSessionUUID.ToString()),
//                new AnalyticsParameter(AnalyticsConstants.EventParameters.GameMode, GameDirector.Instance.CurrentGameMode.ToString()),
//                new AnalyticsParameter(AnalyticsConstants.EventParameters.Score, Score.ToString()),
//                new AnalyticsParameter(AnalyticsConstants.EventParameters.Level, CurrentLevelNumber.ToString()),
//                new AnalyticsParameter(AnalyticsConstants.EventParameters.PlayingTimeMinutesRounded, String.Format("{0:0}", TotalPlayingTimeMilliseconds / 1000f / 60f)),
//                new AnalyticsParameter(AnalyticsConstants.EventParameters.PlayingTimeMilliseconds, TotalPlayingTimeMilliseconds.ToString()));
        }
        ...
        {
            int? demoExpiredDialog = GuideHelper.ShowSyncYesNoButtonAlertMsgBox("Trial Expired", string.Format("Trial mode is limited to {0} minutes. Would you like to buy the full game?", GlobalConstants.TrialExpirationMilliseconds / 60 / 1000));
        ...
        {
            Director.AchievementsManager.ProcessAchievementsByType(GameLibrary.Social.Achievements.Achievement.AchievementType.Normal, elapsedTime);
            Director.AchievementsManager.ProcessAchievementsByType(GameLibrary.Social.Achievements.Achievement.AchievementType.Runtime, elapsedTime);
        }
        ...
        private void OnAchievementCompletedHandler(GameLibrary.Social.Achievements.Achievement achievement)
        {
            if (achievement != null)
            {
                ...
                // Log to analytics
//                Director.AnalyticsService.LogEvent(AnalyticsConstants.Events.AchievementUnlocked,
//                    new AnalyticsParameter(AnalyticsConstants.EventParameters.Id, achievement.Data.Id),
//                    new AnalyticsParameter(AnalyticsConstants.EventParameters.Type, achievement.Type.ToString()),
//                    new AnalyticsParameter(AnalyticsConstants.EventParameters.Name, achievement.Data.Name),
//                    new AnalyticsParameter(AnalyticsConstants.EventParameters.Description, achievement.Data.Description));
            }
        }
        ...
        public GameLibrary.Social.Achievements.Achievement CurrentAchievement { get; set; }
        private Queue<GameLibrary.Social.Achievements.Achievement> AchievementsQueue { get; set; }
