...
namespace GameLibrary.Social.Achievements
{
    ...
    public abstract class Achievement
    {
        ...
        /// Constructor.
        /// </summary>
        /// <param name="id">Id of the Achivement.</param>
        /// <param name="name">Name of the Achivement.</param>
        /// <param name="description">Description of the Achivement.</param>
        ...
        /// Constructor.
        /// </summary>
        /// <param name="data">Id of the Achivement.</param>
        /// <param name="type">Type of the Achivement.</param>
