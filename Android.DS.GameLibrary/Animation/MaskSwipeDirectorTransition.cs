...
namespace GameLibrary.Animation
{
	...
	{
		public MaskSwipeDirectorTransition (Director director, GameLibrary.UI.Texture maskTexture, float initalMasktextureScale, float durationInSecondsForEachPass, GameLibrary.UI.Texture loadingTexture)
            : base(loadingTexture)
		{
			Director = director;
			...
			Matrix halfPixelOffset = Matrix.CreateTranslation (-0.5f, -0.5f, 0); // FIXME: -0.5f what for?
		...
		private GameLibrary.UI.Texture MaskTexture { get; set; }
