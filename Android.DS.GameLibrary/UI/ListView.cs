...
namespace GameLibrary.UI
{
	...
	public class ListView : Layer
	{
		...
		/// <summary>
		/// Handles the touch down event of the ListViewItem.
		/// </summary>
		...
		/// <summary>
		/// Handles the dragging event of the ListViewItem.
		/// </summary>
		/// <param name="obj"></param>
		/// <param name="position"></param>
		...
		/// <summary>
		/// Handles the touch released event of the ListViewItem.
		/// </summary>
		/// <param name="obj"></param>
		/// <param name="position"></param>
		...
		/// <summary>
		/// Processes the current delta (Test list limits, bouncing values, etc..)
		/// </summary>
		...
		/// <summary>
		/// Processes the current motion direction.
		/// </summary>
		/// <param name="position"></param>
		...
		/// <summary>
		/// Draws all subitems of the given item.
		/// </summary>
		/// <param name="item"></param>
		...
		/// <summary>
		/// Hide all subitems of the given item.
		/// </summary>
		/// <param name="item"></param>
