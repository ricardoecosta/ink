...
namespace GameLibrary.UI
{
	public abstract class Scene : IUpdateable, ITouchableContainer
	{
		...
		/// <param name="spriteBatchRenderer">Nullable if the game doesn't use a particle system.</param>
		...
		/// <summary>
		/// Updates the Scene with given elapsed time.
		/// </summary>
		...
		/// <summary>
		/// Finds the touchable elements on all interactive layers.
		/// </summary>
		...
		{
			if (OnInitalizationFinished != null) {
				OnInitalizationFinished (this, EventArgs.Empty);
			}
		}

		public void FireOnUninitalizationFinished ()
		{
			if (OnUninitalizationFinished != null) {
				OnUninitalizationFinished (this, EventArgs.Empty);
			}
		}
		...
		public event EventHandler OnUninitalizationFinished;
		public event EventHandler OnInitalizationFinished;
