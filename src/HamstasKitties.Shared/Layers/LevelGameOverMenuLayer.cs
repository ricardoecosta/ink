...
namespace HamstasKitties.Layers
{
    public class LevelGameOverMenuLayer : Layer
    {
        ...
        public override void Initialize()
        {
            ...
            HamstasKitties.UI.Texture titleTexture = GetTitle();
            ...
            HamstasKitties.UI.Texture subTitleTexture = ParentScene.Director.CurrentResourcesManager.GetCachedTexture((int)GameDirector.TextureAssets.TryAgain);
        ...
        private void CreateButtons()
        {
            ...
            HamstasKitties.UI.Texture yesRetryButtonTexture = resources.GetCachedTexture((int)GameDirector.TextureAssets.GameOverRetry);
            ...
            yesRetryButton.OnPushComplete += (btn, sender) =>
            {
                if (!OptionAlreadySelected)
                {
                    ...
                    // If answer is yes, restart level
            ...
            HamstasKitties.UI.Texture scoreLblTexture = (isHighScore && Score > 0) ? resources.GetCachedTexture((int)GameDirector.TextureAssets.NewHighscore) : resources.GetCachedTexture((int)GameDirector.TextureAssets.YouScored);
        ...
        private HamstasKitties.UI.Texture GetTitle()
        {
