...
{
    /// <summary>
    /// Layer that will contain tutorial pages.
    /// </summary>
    public class TutorialContentLayer : PageableLayer
    {
        ...
        public override void Initialize()
        {
            ...
            TutorialPagesTextures = new HamstasKitties.UI.Texture[]
            {
        ...
        private HamstasKitties.UI.Texture[] TutorialPagesTextures { get; set; }
    }
}
