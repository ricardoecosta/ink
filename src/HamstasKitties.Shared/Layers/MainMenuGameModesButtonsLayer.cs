...
namespace HamstasKitties.Layers
{
    public class MainMenuGameModesButtonsLayer : PageableLayer
    {
        ...
        public override void Initialize()
        {
            ...
            GameModesTextures = new HamstasKitties.UI.Texture[]
            {
            ...
            for (int i = 0; i < GameModesTextures.Length; i++)
            {
                ...
                if (director.IsTrialMode && i > 0)
                {
                    ...
                    {
                        // TODO: Implement full version purchase dialog
                    };
                }
                else
                {
        ...
        /// <summary>
        /// Disables all modes buttons except current one.
        /// </summary>
        ...
        private HamstasKitties.UI.Texture[] GameModesTextures { get; set; }
