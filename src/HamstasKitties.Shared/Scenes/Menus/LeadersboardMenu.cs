...
namespace HamstasKitties.Scenes.Menus
{
    ...
    public class LeadersboardMenu : Scene
    {
        ...
        public override void Initialize()
        {
            ...
            HamstasKitties.UI.Texture containerTexture = resources.GetCachedTexture((int)GameDirector.TextureAssets.LeaderboardBackground);
            ListView = new ListView(this, 2, HamstasKitties.UI.ListView.ViewType.List);
        ...
        {
            // Platform-specific Scoreloop handling removed
        }
