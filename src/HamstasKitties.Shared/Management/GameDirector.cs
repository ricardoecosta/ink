...
using HamstasKitties.Achievements;
...
namespace HamstasKitties.Management
{
    public class GameDirector : Director
    {
        ...
        protected override void PreInitialize()
        {
            ...
            GameDirector.Instance.SettingsManager.AddKnownType(typeof(Social.Achievements.AchievementData));
        ...
        private void CreateAchievements()
        {
            ...
            if (AchievementsManager.Achievements != null && AchievementsManager.Achievements.Count == 0)
            {
                ...
                AchievementsManager.AddAchievement(new UnlockedSpecialTypeAchievement("4", "Lenny Wizard", "Arbitrarily removes 20 characters from room!", 1, Block.SpecialTypes.MagicBomb));
                ...
                AchievementsManager.AddAchievement(new GameModeAchievement("18", "Gold Rush Mode", "Oh precious metal! Here we go!", GameModes.GoldRush, 1));

                AchievementsManager.AddAchievement(new ItemsRemovalAchievement("20", "15 Gold Pieces", "The more you get, more you want!", 15, Block.BlockTypes.GoldenBlock));
                ...
                AchievementsManager.AddAchievement(new GameModeAchievement("26", "Countdown Mode", "Beat other online players! Go for TOP 3!", GameModes.Countdown, 1));
            }
        ...
        /// Shows tutorial.
        /// </summary>
        /// <param name="pushScene">If is true pushes scene. Then loads as single scene.</param>
        ...
        public enum TextureAssets // FIXME: Move to assets manager
        {
            ...
            AchievementUnlockedBaseShield,
            AchievementUnlockedHamsta,
            HamstaBlink,

            LevelPauseMenuBG,
            LevelPauseResumeButton,
            LevelPauseRestartButton,
            LevelPauseMainMenuButton,

            LevelGameOverMenuBG,
            LevelGameOverRetryButton,
            LevelGameOverMainMenuButton,
            LevelGameOverButtonDisabled,
            LevelGameOverCloud,
            LevelGameOverStatsBackground,
            LevelGameOverStatsIndicator,
            LevelGameOverShareButton,
            LevelGameOverShareButtonDisabled,
            ...
            Tutorial8NextButton,
            Tutorial9NextButton,
            Tutorial10NextButton,
            Tutorial11NextButton,
            Tutorial12NextButton,
            ...
            AchievementsMenuItemIcon,
            LeaderboardsMenuItemIcon,
            AboutMenuItemIcon,
