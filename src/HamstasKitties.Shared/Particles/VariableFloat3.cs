...
namespace HamstasKitties.Particles
{
#nullable disable
    using System;
    ...
    public struct VariableFloat3 : IEquatable<VariableFloat3>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Vector3"/> to <see cref="VariableFloat3"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="VariableFloat3"/> to <see cref="Microsoft.Xna.Framework.Vector3"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
