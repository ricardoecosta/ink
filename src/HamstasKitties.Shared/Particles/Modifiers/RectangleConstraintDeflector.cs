...
namespace HamstasKitties.Particles.Modifiers
{
    ...
    public sealed class RectangleConstraintDeflector : Modifier
    {
        ...
        protected internal override void Process(float dt, Particle[] particleArray, int count)
        {
            ...
            {
                float halfScale = particleArray[i].Scale * 0.5f;

                if (particleArray[i].Position.X < left)
                {
                    particleArray[i].Position.X = left;
                    ...
                    particleArray[i].Momentum.X *= -momentumDelta;
                }
                else if (particleArray[i].Position.X > right)
                {
                    particleArray[i].Position.X = right;
                ...
                if (particleArray[i].Position.Y < top)
                {
                    particleArray[i].Position.Y = top;
                    ...
                    particleArray[i].Momentum.Y *= -momentumDelta;
                }
                else if (particleArray[i].Position.Y > bottom)
                {
                    particleArray[i].Position.Y = bottom;
