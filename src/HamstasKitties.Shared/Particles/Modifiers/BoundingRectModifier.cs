...
namespace HamstasKitties.Particles.Modifiers
{
    ...
    public sealed class BoundingRectModifier : Modifier
    {
        ...
        protected internal override void Process(float elapsedSeconds, Particle[] particleArray, int count)
        {
            ...
            {
                minX = particleArray[i].Position.X < minX ? particleArray[i].Position.X : minX;
                maxX = particleArray[i].Position.X > maxX ? particleArray[i].Position.X : maxX;
                minY = particleArray[i].Position.Y < minY ? particleArray[i].Position.Y : minY;
                maxY = particleArray[i].Position.Y > maxY ? particleArray[i].Position.Y : maxY;
            }
