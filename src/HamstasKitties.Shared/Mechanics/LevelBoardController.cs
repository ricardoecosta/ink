...
{
    public class LevelBoardController : HamstasKitties.UI.IUpdateable
    {
        ...
        /// <summary>
        /// Creates a new block and return it. This method don't attach's block to the board.
        /// </summary>
        /// <param name="type">Block Type.</param>
        /// <param name="index">Column of block.</param>
        /// <param name="attachToParentLayer">Attaches created block to parent layer.</param>
        ...
        private bool IsBoardCleared()
        {
            ...
            // We only need to check on bottom line
        ...
        /// <summary>
        /// Verifies if given block can be moved for given Direction.
        /// </summary>
        /// <param name="block"></param>
        /// <returns></returns>
        ...
        {
            // To prevent removal of new blocks generated/upgraded by originBlock's matching group.
