...
namespace HamstasKitties.Sprites
{
    ...
    public class AchievementEntry : ListViewItem
    {
            ...
            : base(parent, null)
        {
            ...
            Icon = GameDirector.Instance.CurrentResourcesManager.GetCachedTexture((int)(Achievement.Data.Completed ? GameDirector.TextureAssets.AchievementUnlocked : GameDirector.TextureAssets.AchievementLocked));
        }
        ...
        public override void DrawJustLayerObject(Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch)
        {
            if (Icon != null)
            {
                ...
                if (TitleText == null || Size.X != CachedTitleWidth)
                {
                    ...
                    TitleText = new Text(ParentLayer, titlePos, TitleFont, ApplyEllipsis(Achievement.Data.Name, TitleFont, Size.X), new Color(255, 94, 0), Color.Black);
                }

                if (DescriptionTexts == null || Size.X != CachedDescriptionWidth)
                {
                    CachedDescriptionWidth = CachedTitleWidth;
                    List<StringBuilder> lines = GetTextLines(Achievement.Data.Description, DescriptionFont, CachedDescriptionWidth, DescriptionMaxLines);
