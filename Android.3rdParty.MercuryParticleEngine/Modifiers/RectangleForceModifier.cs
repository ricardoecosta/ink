...
namespace ProjectMercury.Modifiers
{
    ...
    public sealed class RectangleForceModifier : Modifier
    {
        ...
        protected internal override void Process(float dt, Particle[] particleArray, int count)
        {
            ...
            {
                if (particleArray[i].Position.X > this.Left)
                    if (particleArray[i].Position.X < this.Right)
                        if (particleArray[i].Position.Y > this.Top)
                            if (particleArray[i].Position.Y < this.Bottom)
                            {
                                particleArray[i].Velocity.X += deltaForceX;
                                particleArray[i].Velocity.Y += deltaForceY;
                            }
            }
        }
    }
