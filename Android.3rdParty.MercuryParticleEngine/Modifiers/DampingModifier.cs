...
namespace ProjectMercury.Modifiers
{
    ...
    public sealed class DampingModifier : Modifier
    {
        ...
        protected internal override void Process(float dt, Particle[] particleArray, int count)
        {
            ...
            {
                particleArray[i].Velocity.X += particleArray[i].Momentum.X * inverseCoefficientDelta;
                particleArray[i].Velocity.Y += particleArray[i].Momentum.Y * inverseCoefficientDelta;
            }
        }
    }
}
